  ...
  $.Unslider = function(context, options) {
    ...
    self.init = function(options) {
      ...
      self.$container = self.$context
        .find(self.options.selectors.container)
        .addClass(self.prefix + "wrap");
    ...
    self.setup = function() {
      ...
      self.$context
        .addClass(self.prefix + self.options.animation)
        .wrap('<div class="' + self._ + '" />');
    ...
    self.calculateSlides = function() {
      ...
      if (self.options.animation !== "fade") {
        ...
        self.$container
          .css(prop, self.total * 100 + "%")
          .addClass(self.prefix + "carousel");
    ...
    self.initNav = function() {
      ...
      self.$slides.each(function(key) {
        ...
        $nav
          .children("ol")
          .append('<li data-slide="' + key + '">' + label + "</li>");
      });
    ...
    self.initArrows = function() {
      ...
      $.each(self.options.arrows, function(key, val) {
        ...
        self.$arrows.push(
          $(val)
            .insertAfter(self.$context)
            .on("click" + self.eventSuffix, self[key])
        );
      });
    };
      ...
      if (self.options.animation !== "fade") {
        self.$container.on({
          ...
          move: function(e) {
            self.$container.css(
              "left",
              -(100 * self.current) + 100 * e.distX / width + "%"
            );
          },
    ...
    self.initInfinite = function() {
      ...
      $.each(pos, function(index, item) {
        self.$slides.push.apply(
          ...
          self.$slides
            .filter(':not(".' + self._ + '-clone")')
            [item]()

            //  Make a copy of it and identify it as a clone
            .clone()
            .addClass(self._ + "-clone")
    ...
    self.setIndex = function(to) {
      ...
      if (self.options.nav) {
        self.$nav
          .find('[data-slide="' + self.current + '"]')
          ._active(self.options.activeClass);
      }
