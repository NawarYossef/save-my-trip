    ...
    it('should return trips with right fields', function() {
      ...
      return chai.request(app)
        ...
        .then(function(trip) {
          ...
          let tripDepartureDateMseconds = new Date(trip.departure.date).getMilliseconds();
          let resTripDepartureDateMseconds = new Date(resTrip.departure.date).getMilliseconds();

          let tripArrivalDateMseconds = new Date(trip.arrival.date).getMilliseconds();
          let resTripArrivalDateMseconds = new Date(resTrip.arrival.date).getMilliseconds();
    ...
    it('should add a new trip', function() {
      ...
      return chai.request(app)
        ...
        .then(function(res) {
          ...
          // use dates to create two instances of the Date object.
          //  call 'getMilliseconds() to compare both values'
          let resDepartureDateMseconds = new Date(res.body.departure.date).getMilliseconds();
          let newTripDepartureDateMseconds = new Date(newTrip.departure.date).getMilliseconds();

          let resArrivalDateMseconds = new Date(res.body.arrival.date).getMilliseconds();
          let newTripArrivalDateMseconds = new Date(newTrip.arrival.date).getMilliseconds();
        ...
        .then(function(trip) {
          ...
          // use dates to create two instances of the Date object.
          //  call 'getMilliseconds() to compare both values'
          let resDepartureDateMseconds = new Date(newTrip.departure.date).getMilliseconds();
          let tripDepartureDateMseconds = new Date(trip.departure.date).getMilliseconds();

          let resArrivalDateMseconds = new Date(newTrip.arrival.date).getMilliseconds();
          let tripArrivalDateMseconds = new Date(trip.arrival.date).getMilliseconds();
